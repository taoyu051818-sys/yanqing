...
<template>
  <view class="page safe-bottom">
    ...
    <SectionEmpty v-if="!coupons.length && !loading" title="券包还是空的" description="参加活动或输入券码领取本地生活权益" />
...
<style scoped>
.title { display: block; margin-bottom: 10rpx; font-size: 31rpx; font-weight: 800; }.inline { display: flex; gap: 14rpx; margin-top: 22rpx; }.inline .input { flex: 1; }.inline button { flex: 0 0 150rpx; padding: 0; }
...
.merchant { font-weight: 700; }.benefit { display: block; margin: 26rpx 0 20rpx; font-size: 31rpx; font-weight: 800; }.code { display: block; padding-top: 20rpx; margin-top: 20rpx; color: #758079; border-top: 1rpx dashed #dce2dd; font-family: monospace; font-size: 22rpx; letter-spacing: 2rpx; }
