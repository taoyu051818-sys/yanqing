...
import { isTrainingApprover, assertTrainingApprover, hasAnyRole } from './training-access.js';
import { assertSettlementPeriodUnlocked } from './training-settlement-ledger.js';
import {
  financialSummary,
  createSettlement,
  listSettlements,
...
export class TrainingService {
  ...
  async createStudent(dto: CreateStudentDto, actor: AuthUser) {
    ...
    if (
      ...
      !hasAnyRole(actor, STUDENT_STAFF_ROLES)
    ) {
